...
ln -sf "${CURRENT_SCRIPT_DIR}/:syslog-ng-core/assets/config/syslog_ng_default" /etc/syslog-ng/syslog-ng
ln -sf "${CURRENT_SCRIPT_DIR}/:syslog-ng-core/assets/config/syslog-ng.conf" /etc/syslog-ng/syslog-ng.conf
