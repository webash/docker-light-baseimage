...
echo "Download cfssl ..."
echo "curl -o /usr/sbin/cfssl -SL https://github.com/cloudflare/cfssl/releases/download/v1.6.1/cfssl_1.6.1_linux_${HOST_ARCH}"
curl -o /usr/sbin/cfssl -SL "https://github.com/cloudflare/cfssl/releases/download/v1.6.1/cfssl_1.6.1_linux_${HOST_ARCH}"
chmod 700 /usr/sbin/cfssl

echo "Download cfssljson ..."
echo "curl -o /usr/sbin/cfssljson -SL https://github.com/cloudflare/cfssl/releases/download/v1.6.1/cfssljson_1.6.1_linux_${HOST_ARCH}"
curl -o /usr/sbin/cfssljson -SL "https://github.com/cloudflare/cfssl/releases/download/v1.6.1/cfssljson_linux-${HOST_ARCH}"
